...
fn ipc_types() -> TypeCollection {
    ...
    types
        ...
        .register::<LinkStatusKind>()
        .register::<LinkStatus>()
        .register::<LinkHealthItem>()
        .register::<LinkCheckReport>()
        // vault read shapes
        .register::<ItemType>()
        .register::<VaultItem>()
        .register::<LoginUri>()
        .register::<PasswordHistoryEntry>()
        ...
        .register::<SendExpiry>()
        .register::<SendCreateInput>()
        .register::<SendFileCreateInput>()
        .register::<SendCreated>()
        .register::<Collection>()
        .register::<TotpCode>()
        .register::<Folder>()
        ...
        .register::<AutofillMode>()
        .register::<AutofillField>()
        .register::<AutofillContext>()
        .register::<AutofillCandidate>()
        .register::<AutofillPending>()
        .register::<AutofillStatus>()
        // typed error surface
        .register::<ErrorKind>()
        .register::<AgateError>();
    types
