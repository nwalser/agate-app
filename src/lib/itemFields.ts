// Pure formatters/helpers for the item detail pane and editor (card expiry +
// brand, identity field rows, custom-field linked-id maps). Kept out of the
// components so they can be unit-tested without a render rig.
