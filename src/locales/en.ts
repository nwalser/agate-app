...
export const en = {
  ...
  trayVaults: {
    ...
    setDefaultVault: 'Set as default for new items',
    defaultVaultActive: 'Default for new items',
  ...
  tray: {
    ...
    unnamedOrganization: 'Organization',
    strength: {
      veryWeak: 'Very weak',
      weak: 'Weak',
      fair: 'Fair',
  ...
  autofill: {
    ...
    rememberPrompt: 'Remember {name} for {target}?',
    rememberAndFill: 'Remember & fill',
    justFill: 'Just fill',
  },
